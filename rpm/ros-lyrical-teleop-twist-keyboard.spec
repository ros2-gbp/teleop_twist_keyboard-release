...
%global pkg_name teleop_twist_keyboard
%global normalized_pkg_name %{lua:return (string.gsub(rpm.expand('%{pkg_name}'), '_', '-'))}

Name:           ros-lyrical-teleop-twist-keyboard
Version:        2.4.1
Release:        3%{?dist}
...
%changelog
* Wed Apr 29 2026 Chris Lalancette <clalancette@openrobotics.org> - 2.4.1-3
- Autogenerated by Bloom

* Tue Apr 28 2026 Chris Lalancette <clalancette@openrobotics.org> - 2.4.1-2
- Autogenerated by Bloom

* Tue Apr 21 2026 Chris Lalancette <clalancette@openrobotics.org> - 2.4.1-1
- Autogenerated by Bloom
